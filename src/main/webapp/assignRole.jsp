                ...
                <div class="panel-body">
                    <form role="form" class="form-inline" id="RoleForm">
                        <div class="form-group">
                            ...
                            <select name="unAssignRoleIds" id="unAssignRoleSelect" class="form-control" multiple size="10" style="width:200px;overflow-y:auto;">
                        ...
                        <div class="form-group">
                            <ul>
                                ...
                                <br>
                                <li class="btn btn-default glyphicon glyphicon-chevron-left" style="margin-top:20px;" onclick="leftButtonClick()"></li>
                            </ul>
                        </div>
                        <div class="form-group" style="margin-left:40px;">
                            <label>已分配角色列表</label><br>
                            <select name="assignRoleIds" id="assignRoleSelect" class="form-control" multiple size="10" style="width:200px;overflow-y:auto;">
...
<script type="text/javascript">
    ...
    function rightButtonClick() {
        ...
        if(leftSelect.length==0)
        {
            ...
            $.ajax({
                type:"POST",
                url:"${pageContext.request.contextPath}/role/assignRole",
    ...
    function leftButtonClick() {
        ...
        if(rightSelect.length==0)
        {
            ...
            $.ajax({
                type:"POST",
                url:"${pageContext.request.contextPath}/role/unAssignRole",
                data:$("#RoleForm").serialize(),
                success:function () {
                    layer.msg("取消分配成功")
                    $("#unAssignRoleSelect").append(rightSelect);
