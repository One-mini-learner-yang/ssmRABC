            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form role="form" id="fromUser">
                        ...
                        <button type="button" class="btn btn-danger" onclick="resetClick()"><i class="glyphicon glyphicon-refresh"></i> 重置</button>
                    </form>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    function updateUser() {
        $.ajax({
            ...
            beforeSend:function () {
                layer.msg("请稍后",{time:1000})
            },
            success:function () {
                layer.msg("信息修改成功",{time:2000,icon:1},function () {
