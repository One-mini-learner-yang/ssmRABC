  ...
  <body>
			...
			<div class="panel panel-default">
			  ...
			  <div class="panel-body">
				<form role="form">
				  ...
				  <button type="button" class="btn btn-success" onclick="runTo()"><i class="glyphicon glyphicon-plus"></i> 新增</button>
	...
	<script src="${pageContext.request.contextPath}/script/docs.min.js"></script>
        <script type="text/javascript">
            ...
            function runTo() {
					window.location.href="${pageContext.request.contextPath}/user/add?username="+$("#username").val()+"&name="+$("#name").val()+"&email="+$("#email1").val();
			}
        </script>
  </body>
</html>
