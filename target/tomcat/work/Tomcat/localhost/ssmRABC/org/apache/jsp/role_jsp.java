 ...
 * Generated at: 2020-02-07 14:05:49 UTC
...
public final class role_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("                            </li>\r\n");
      out.write("                            <li style=\"height:30px;\">\r\n");
      out.write("                                <a href=\"role.jsp\" style=\"color:red;\"><i class=\"glyphicon glyphicon-king\"></i> 角色维护</a>\r\n");
      out.write("                            </li>\r\n");
      out.write("                            <li style=\"height:30px;\">\r\n");
      ...
      out.write("                                <input class=\"form-control has-success\" id=\"inputFind\" type=\"text\" placeholder=\"请输入查询条件\">\r\n");
      out.write("                            </div>\r\n");
      out.write("                        </div>\r\n");
      out.write("                        <button type=\"button\" class=\"btn btn-warning\" onclick=\"findById()\"><i class=\"glyphicon glyphicon-search\"></i> 查询</button>\r\n");
      out.write("                    </form>\r\n");
      ...
      out.write("                    <button type=\"button\" class=\"btn btn-primary\" style=\"float:right;\" onclick=\"window.location.href='addRole.jsp'\"><i class=\"glyphicon glyphicon-plus\"></i> 新增</button>\r\n");
      out.write("                    <br>\r\n");
      ...
      out.write("            layer.msg(\"查询条件不可为空\");\r\n");
      out.write("        else{\r\n");
      out.write("            findByIdIndex=1;\r\n");
      out.write("            pageQuery(1);\r\n");
      out.write("        }\r\n");
      out.write("    }\r\n");
      out.write("    function pageQuery(pageNum) {\r\n");
      out.write("        var loadIndex=null;\r\n");
      out.write("        var jsonData={\"pageNum\":pageNum,\"pageSize\":5};\r\n");
      out.write("        if(findByIdIndex==1){\r\n");
      ...
      out.write("                loadIndex=layer.msg(\"稍后\",{time:1})\r\n");
      out.write("            },\r\n");
      ...
      out.write("                    var rolePage = result.page;\r\n");
      out.write("                    var roles = rolePage.ts;\r\n");
      out.write("                    $.each(roles,function (i,role) {\r\n");
      out.write("                        tableContext+='<tr>';\r\n");
      out.write("                        tableContext+='<td>'+(i+1)+'</td>';\r\n");
      out.write("                        tableContext += '<td><input type=\"checkbox\"></td>';\r\n");
      out.write("                        tableContext += '<td>'+role.name+'</td>';\r\n");
      out.write("                        tableContext += '<td>';\r\n");
      out.write("                        tableContext += '<button type=\"button\" class=\"btn btn-success btn-xs\"><i class=\" glyphicon glyphicon-check\"></i></button>';\r\n");
      out.write("                        tableContext += '<button type=\"button\" class=\"btn btn-primary btn-xs\"><i class=\" glyphicon glyphicon-pencil\"></i></button>';\r\n");
      out.write("                        tableContext += '<button type=\"button\" class=\"btn btn-danger btn-xs\"><i class=\" glyphicon glyphicon-remove\"></i></button>';\r\n");
      out.write("                        tableContext += '</td>';\r\n");
      out.write("                        tableContext += '</tr>';\r\n");
      out.write("                    });\r\n");
      out.write("                    if (pageNum>1)\r\n");
      out.write("                        pageContext+='<li><a href=\"#\" onclick=\"pageQuery('+(pageNum-1)+')\">上一页</a></li>';\r\n");
      out.write("                    for(i=1;i<=rolePage.totalNum;i++)\r\n");
      out.write("                    {\r\n");
      out.write("                        if(pageNum==i)\r\n");
      out.write("                            pageContext+='<li class=\"active\" onclick=\"pageQuery('+i+')\"><a href=\"#\">'+i+'<span class=\"sr-only\">(current)</span></a></li>';\r\n");
      out.write("                        if(pageNum!=i)\r\n");
      out.write("                            pageContext+='<li><a href=\"#\" onclick=\"pageQuery('+i+')\">'+i+'</a></li>';\r\n");
      out.write("                    }\r\n");
      out.write("                    if(pageNum<rolePage.totalNum)\r\n");
      out.write("                    {\r\n");
      out.write("                        pageContext+='<li><a href=\"#\" onclick=\"pageQuery('+(pageNum+1)+')\">下一页</a></li>';\r\n");
      out.write("                    }\r\n");
      out.write("                    $(\"#roleBody\").html(tableContext);\r\n");
      out.write("                    $(\".pagination\").html(pageContext);\r\n");
      out.write("                }else {\r\n");
      out.write("                    layer.msg(\"角色分页查询失败\")\r\n");
      out.write("                }\r\n");
      out.write("            }\r\n");
      out.write("\r\n");
      out.write("        });\r\n");
